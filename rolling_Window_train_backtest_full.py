...
def parse_args():
    ...
    parser.add_argument('--n_epochs', type=int, default=10, help='Number of epochs for reinforcement learning')
    parser.add_argument('--rl_batch_size', type=int, default=512, help='Batch size for reinforcement learning')
    parser.add_argument('--steps_per_episode', type=int, default=1024, help='Steps per episode for reinforcement learning')
